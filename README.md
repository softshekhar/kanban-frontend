...
Create React App uses [Jest](https://facebook.github.io/jest/) as its test runner. To prepare for this integration, we did a [major revamp](https://facebook.github.io/jest/task/2016/09/01/jest-15.html) of Jest so if you heard bad things about it years ago, give it another try.
...
![Jest watch mode](http://facebook.github.io/jest/img/task/15-watch.gif)
...
Finally, jsdom is also not needed for [snapshot testing](http://facebook.github.io/jest/task/2016/07/27/jest-14.html).

### Snapshot Testing

Snapshot testing is a feature of Jest that automatically generates text snapshots of your components and saves them on the disk so if the UI output changes, you get notified without manually writing any assertions on the component output. [Read more about snapshot testing.](http://facebook.github.io/jest/task/2016/07/27/jest-14.html)
...
See [this](https://medium.com/@to_pe/deploying-create-react-app-on-microsoft-azure-c0f6686a4321) task post on how to deploy your React app to [Microsoft Azure](https://azure.microsoft.com/).
...
You can find instructions in [Deploying React with Zero Configuration](https://task.heroku.com/deploying-react-with-zero-configuration).
...
See the [Modulus task post](http://task.modulus.io/deploying-react-apps-on-modulus) on how to deploy your react app to Modulus.
...
Details are available in [this article.](https://zeit.co/task/now-static)

### S3 and CloudFront

See this [task post](https://medium.com/@omgwtfmarc/deploying-create-react-app-to-s3-or-cloudfront-48dae4ce0af) on how to deploy your React app to Amazon Web Services [S3](https://aws.amazon.com/s3) and [CloudFront](https://aws.amazon.com/cloudfront/).
