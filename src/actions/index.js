...
//Action creator
export function removeTaskSucceeded(id) {
  console.log('removeTask(ActionCreator) of actions/index.js called');
  return {
...
export function removeTask(id, params = {}) {
  return (dispatch, getState) => {
    api.removeTask(id).then(resp => {
      dispatch(removeTaskSucceeded(id));
    });
  };
}